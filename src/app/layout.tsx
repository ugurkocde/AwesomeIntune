...
export const metadata: Metadata = {
  ...
  icons: {
    icon: [
      {
        url: "/favicon-32x32.png?v=20260816",
        sizes: "32x32",
        type: "image/png",
      },
      {
        url: "/favicon-192x192.png?v=20260816",
        sizes: "192x192",
        type: "image/png",
      },
      { url: "/awesome-a-512.png", sizes: "512x512", type: "image/png" },
      {
        url: "/favicon-16x16.png?v=20260816",
        sizes: "16x16",
        type: "image/png",
      },
      { url: "/favicon.ico?v=20260816", sizes: "any" },
    ],
    apple: [{ url: "/apple-touch-icon.png?v=20260816", sizes: "180x180" }],
  },
