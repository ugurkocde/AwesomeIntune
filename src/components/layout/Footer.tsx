          ...
          <div className="space-y-4">
            ...
            <nav className="flex flex-col gap-2">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex touch-manipulation items-center gap-2 text-sm transition-colors hover:text-[var(--accent-primary)] focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[var(--accent-primary)]"
                style={{ color: "var(--text-secondary)" }}
              >
                <svg
                  width="16"
